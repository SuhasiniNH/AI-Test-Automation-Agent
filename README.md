...
1. **Generates** test cases covering the happy path, edge cases, and failure modes.
2. **Executes** those test cases.
3. **Analyzes** any failures and attaches a suggested root cause.
4. **Builds** a pass/fail report and persists it for later retrieval.
